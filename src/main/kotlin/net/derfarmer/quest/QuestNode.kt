...
open class QuestNode(
    ...
    open val completed: Boolean, val connectionsTo: List<Int>
)

class BakedQuestNode(
    override val questID: Int, override val itemID: String, override val title: String,
